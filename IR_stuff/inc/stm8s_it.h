...
/* Includes ------------------------------------------------------------------*/
#include "stm8s.h"
#define MAX_PULSES 110
extern volatile uint8_t pulse_count;
extern volatile uint8_t col;
extern volatile uint8_t capture_done;
extern volatile uint8_t first_edge; 
extern volatile uint16_t last_edge;
extern volatile uint16_t pulses[MAX_PULSES];
extern volatile uint8_t dly_count;
/* Exported types ------------------------------------------------------------*/
/* Exported constants --------------------------------------------------------*/
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
